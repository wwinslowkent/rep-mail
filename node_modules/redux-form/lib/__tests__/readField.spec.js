...
describe('readField', function () {
  ...
  it('should change complex field instances when updating a mixed field', function () {
    ...
    (0, _expect2.default)(beforeArrayField).toNotBe(afterArrayField); // field instance should be different
    (0, _expect2.default)(beforeObjectField).toNotBe(afterObjectField); // field instance should be different
  });
